...

{
	0x400 , data => new Data {
		...
		{ "ADC_FL_CoolingFL", Uint(data[6], data[7])}
	}
},
...

{
	0x410 , data => new Data {
		...
		{ "ADC_FR_CoolingFR", Uint(data[6], data[7])}
	}
},
...

{
	0x421 , data => new Data {
		...
		{ "ADC_REAR_CoolingRL", Uint(data[4], data[5])},
		{ "ADC_REAR_CoolingRR", Uint(data[6], data[7])}
	}
},
...
{
    0x445 , data => new Data {
        {"Power"        , Int(data[0], data[1])*10},
        {"Voltage_SOC"  , Int(data[2], data[3])/10}
    }
},
...

{
    0x522 , data => new Data {
        ...
        {"BMS_Cell_Voltage_135", Uint(data[6], data[7])*0.0001}
    }
},
...

{
    0x562 , data => new Data {
        ...
        {"BMS_Cell_Temperature_135", Uint(data[6], data[7])*0.1}
    }
},
